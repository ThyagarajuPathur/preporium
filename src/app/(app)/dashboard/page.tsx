...
import { ArrowUpRight, Flame, Layers2, RotateCcw, Target } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="flex flex-col gap-5 rounded-[2rem] border border-border/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(250,244,236,0.88))] p-7 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
